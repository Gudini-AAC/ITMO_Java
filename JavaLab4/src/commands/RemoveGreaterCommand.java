...
public class RemoveGreaterCommand implements Command {
	...
	public void execute(Database database, String[] args, CommandExecutionContext context) throws CommandException, IOException {
		if (args.length != 1) {
			String message = "Command \"remove_greater\" expects one argument - location.z, but ";
			if (args.length == 0) {
	...
	@Override
	public String description() { return "Remove values that have a location.z greater than given."; }
