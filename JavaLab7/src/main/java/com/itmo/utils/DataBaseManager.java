...
//                "coordinate_x integer, coordinate_y integer, students_count integer, height real, admin_name varchar(30), weight real, passport_id varchar(30), x_admin real, y_admin real, id real, name varchar(30), creation_date date, form_of_education varchar(30), semester varchar(30), owner varchar(30)" + ");");
...
//        statement.setLong(3, 21);
//        statement.setLong(4, 23);
//        statement.setObject(5, "01.09.2002");
//        statement.setLong(6, 5);
//        statement.setObject(7, "FULL_TIME_EDUCATION");
//        statement.setObject(8, "FIFTH");
//        statement.setString(9, "vanya");
//        statement.setLong(10, 5);
//        statement.setLong(11, 10);
//        statement.setString(12, "1213213");
//        statement.setDouble(13, 5);
//        statement.setLong(14, 5);
//        statement.setString(15, "vankruer");
//        statement.setString(16, "hellovaya");
//        studyGroup.setId(id);
//        statement.execute();
