...
public class Handler {
    ...
    public void setDefaultPack(){
        ...
        addCommand(new RemoveFirstCommand().toString(), new RemoveFirstCommand());
        addCommand(new RemoveLowerCommand().toString(), new RemoveLowerCommand());
        addCommand(new RemoveAny().toString(), new RemoveAny());
        addCommand(new MaxByName().toString(), new MaxByName());
    }
